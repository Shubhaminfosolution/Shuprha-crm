...
class LeadAdmin(ImportExportModelAdmin):
    ...
    list_filter = (
        "status",
        "source",
        "business",        # ← filter by business in sidebar
        "assigned_to",
        "created_at",
    )
    ...
    fieldsets = (
        ...
        # ← Business & Form assignment — the key addition
        ("Business & Source", {
            "fields": (
                "business",
                "ad_form",
    ...
    mark_as_contacted.short_description = "Mark selected leads as In Progress"
    ...
    def whatsapp_button(self, obj):
        try:
            ...
            return format_html(
                ...
                '<svg width="20" height="25" viewBox="0 0 32 32" fill="#25D366">'
